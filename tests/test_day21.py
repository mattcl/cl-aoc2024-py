...
# ======= solutons =========#
#############################
EXAMPLE_PART_ONE = 126384
EXAMPLE_PART_TWO = 154115708116294
PART_ONE = 197560
PART_TWO = 242337182910752
...
def example_input() -> str:
    with open("inputs/day21_example.txt", "r") as f:
        return f.read()
...
def test_day21(benchmark, real_input: str):
    ...
    result = benchmark(run, real_input)
